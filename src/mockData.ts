...
export const initialEmails: EmailMessage[] = [
  ...
  },
  {
    ...
    preview: 'Please find attached the revised brand guidelines for the MyAxis project…',
    body: 'Hi,\n\nPlease find attached the revised brand guidelines for the MyAxis project.\n\nKey changes:\n- Updated colour palette\n- New typography scale\n- Icon set v2\n\nLet us know if you have any questions.\n\nDesign Studio',
